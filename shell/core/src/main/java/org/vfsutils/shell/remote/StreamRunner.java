...
public class StreamRunner implements ConsoleInterface, EngineRunner {
	...
	public StreamRunner() throws IOException {
		PipedReader pipedReader = new PipedReader(inBuffer);
		this.reader = new BlockingReader(pipedReader);
	}
	
	/* (non-Javadoc)
	 * @see org.vfsutils.shell.remote.EngineRunner#startEngine(org.vfsutils.shell.Engine)
	 */
	...
	/* (non-Javadoc)
	 * @see org.vfsutils.shell.remote.EngineRunner#stopEngine()
	 */
	...
	/* (non-Javadoc)
	 * @see org.vfsutils.shell.remote.EngineRunner#handleInput(org.vfsutils.shell.remote.ShellRequest)
	 */
